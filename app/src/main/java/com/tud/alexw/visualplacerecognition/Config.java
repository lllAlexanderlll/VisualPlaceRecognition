...
public class Config {
    ...
    public Config(Context context, String[] codebookFilePaths, Integer[] codebookSizes, String pcaFilePath, int projectionLength, boolean doWhitening, String linearIndexDirPath, String pqIndexDirPath, String pqCodebookFilePath) throws IOException {
